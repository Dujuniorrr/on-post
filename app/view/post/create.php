    <main class="mt-3 mb-3 ms-2 me-2 ms-md-0 me-md-0">
        <div class="container">
           <div class="card mb-3">
               <div class="card-header"><a href="<?= URL ?>/posts/index" class="text-primary text-decoration-none">Postagens</a> <span class="text-secondary"> / Escrever Post</span></div>
           </div>
        </div>
        <div class="container border border-2 p-0 rounded-3">
            <form name="write" method="POST" action="<?= URL ?>/posts/create" class="border border-secondary rounded-2">
